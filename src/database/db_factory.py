...
if env_path.exists():
    ...
    print("☁️ Using environment variables from Azure (no .env file)")
...
def _get_client_with_managed_identity(account_name: str):
    ...
    try:
        ...
        print("⚠️ azure-identity package required for managed identity. Install with: pip install azure-identity")
        raise
...
def get_cosmos_client():
    ...
    try:
        ...
        if mongo_connection_string:
            print("✅ Using direct MongoDB connection string")
