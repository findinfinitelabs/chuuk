...
def extract_ot_verse(book_code, chapter, verse):
    ...
    if book_code.upper() in ["GEN", "GENESIS"]:
        book_abbrev = "GN"
    elif book_code.upper() in ["EXO", "EXODUS", "EXOD"]:
        book_abbrev = "EX"
    elif book_code.upper() in ["LEV", "LEVITICUS"]:
        book_abbrev = "LV"

    # Filenames are like GEN.xhtml, EXO.xhtml
    file_mapping = {"GN": "GEN", "EX": "EXO", "LV": "LEV", "NU": "NUM", "DT": "DEU"}
