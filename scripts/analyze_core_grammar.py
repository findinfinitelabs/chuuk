...
with open(Path(__file__).resolve().parent / "grammar_types_analysis.json") as f:
    data = json.load(f)
...
for item in data["unmapped_types"]:
    ...
    examples[core].append({"full_grammar": grammar, "modifier": modifier, "count": count})
...
core_definitions = {
    "noun": {"description": "A word that represents a person, place, thing, or idea", "example": "chala (basket)"},
    "verb": {"description": "A word that describes an action, state, or occurrence", "example": "chá (to go)"},
    "transitive verb": {
    ...
    "adjective": {"description": "A word that describes or modifies a noun", "example": "cháchcháák (big)"},
    "adverb": {
        "description": "A word that modifies a verb, adjective, or other adverb",
        "example": "chúen (well, properly)",
    },
    "pronoun": {"description": "A word that substitutes for a noun", "example": "ach (I, me)"},
    "possessive": {"description": "Indicates ownership or possession", "example": "ach (my)"},
    "preposition": {
        "description": "A word that shows relationship between nouns/pronouns and other words",
        "example": "aan (at, on)",
    },
    "conjunction": {"description": "A word that connects clauses or sentences", "example": "me (and)"},
    "particle": {
        "description": "A functional word that expresses grammatical relationships",
        "example": "aa (future marker)",
    },
    "interjection": {"description": "An exclamation or sudden remark", "example": "awe (yes)"},
    "auxiliary": {"description": "A helping verb used with main verbs", "example": "pwáán (used to)"},
    "article": {"description": "A word that defines a noun as specific or unspecific", "example": "e (the)"},
    "demonstrative": {"description": "A word that points to specific things", "example": "ei (this)"},
    "interrogative": {"description": "A word used to ask questions", "example": "ifa (who)"},
    "numeral": {"description": "A word representing a number", "example": "eú (one)"},
    "classifier": {
        "description": "A word used to count or classify nouns",
        "example": "eché (classifier for general objects)",
    },
    "ordinal": {"description": "A number indicating position or order", "example": "kaamesen (first)"},
    "quantifier": {"description": "A word that expresses quantity", "example": "fonuun (many)"},
    "locational noun": {"description": "A noun indicating location or place", "example": "lááw (outside)"},
    "relational noun": {
        "description": "A noun expressing spatial or kinship relations",
        "example": "aalen (on, surface of)",
    },
    "temporal noun": {"description": "A noun relating to time", "example": "raán (day)"},
    "number": {"description": "Numerical value (cardinal or ordinal)", "example": "eú (one)"},
}
