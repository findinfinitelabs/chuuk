...
def test_helsinki_tokenization():
    ...
    try:
        ...
        input_tokens = tokenizer(
            batch_inputs, max_length=128, truncation=True, padding="max_length", return_tensors=None
        )
        print("✅ Input tokenization successful")

        target_tokens = tokenizer(
            text_target=batch_targets, max_length=128, truncation=True, padding="max_length", return_tensors=None
        )
