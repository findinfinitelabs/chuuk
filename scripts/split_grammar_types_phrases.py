...
def main():
    ...
    for entry in entries:
        ...
        if grammar not in grammar_types:
            ...
            grammar_types[grammar] = {"count": 0, "core": core, "modifier": modifier}
    ...
    for batch_start in range(0, len(entries), batch_size):
        ...
        for entry in batch:
            ...
            bulk_operations.append(
                UpdateOne({"_id": entry["_id"]}, {"$set": {"grammar": core, "grammar_modifier": modifier}})
            )
        ...
        try:
            ...
            print(
                f"  Processed {batch_end:,}/{len(entries):,} ({batch_end*100//len(entries)}%) - "
